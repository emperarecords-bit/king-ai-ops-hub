...
grant select, insert, update on
  ...
  documents, document_versions, document_chunks, run_document_versions, task_dependencies, decisions, decision_injections, knowledge_injections, knowledge_sources, knowledge_verification_events, knowledge_disclosure_grants, document_disclosure_grants, knowledge_proposals, ai_operations, run_jobs, document_jobs,
  work_items,
...
begin
  foreach t in array array[
    ...
    'objectives', 'milestones', 'knowledge_items', 'task_schedules',
    'documents', 'document_versions', 'document_chunks', 'run_document_versions', 'task_dependencies', 'decisions', 'decision_injections', 'knowledge_injections', 'knowledge_sources', 'knowledge_verification_events', 'knowledge_disclosure_grants', 'document_disclosure_grants', 'knowledge_proposals', 'ai_operations', 'run_jobs',
