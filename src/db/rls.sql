...
grant select, insert, update on
  ...
  documents, document_chunks, task_dependencies, decisions, decision_injections, knowledge_injections, run_jobs, document_jobs,
  work_items,
...
begin
  foreach t in array array[
    ...
    'objectives', 'milestones', 'knowledge_items', 'task_schedules',
    'documents', 'document_chunks', 'task_dependencies', 'decisions', 'decision_injections', 'knowledge_injections', 'run_jobs',
